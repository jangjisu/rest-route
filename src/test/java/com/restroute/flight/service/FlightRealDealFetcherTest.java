...
class FlightRealDealFetcherTest {
    ...
    void fetch_usesRangeCallPlannerAndAssembler_whenSearchModeIsRange() {
        ...
        FlightRealDealFetcher fetcher = new FlightRealDealFetcher(rangeCallPlanner, fixedCallPlanner, dealAssembler);
        ...
        List<FlightDealResponse> result = fetcher.fetch(request);
    ...
    void fetch_usesFixedCallPlanner_whenSearchModeIsFixed() {
        FlightRangeCallPlanner rangeCallPlanner = mock(FlightRangeCallPlanner.class);
        FlightFixedCallPlanner fixedCallPlanner = mock(FlightFixedCallPlanner.class);
        FlightDealAssembler dealAssembler = mock(FlightDealAssembler.class);
        FlightRealDealFetcher fetcher = new FlightRealDealFetcher(rangeCallPlanner, fixedCallPlanner, dealAssembler);
