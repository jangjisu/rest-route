package com.restroute.flight.service.dto;

import java.util.List;

/**
 * {@code FlightRangeSearchPlanner}가 정한 실제 Travelpayouts 조회 계획.
 *
 ...
 */
public record FlightRangeSearchPlan(List<String> destinations, List<String> months, List<NightsWindow> nightsWindows) {

    public record NightsWindow(int min, int max) {}
}
